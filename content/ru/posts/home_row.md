...
Наконец, модификации домашнего ряда (или вариации этой концепции, о которых мы поговорим далее в статье) - это (*часть*) секретный соус для того, чтобы сделать все эти крошечные клавиатуры без крайних <abbr title="В оригинале columns — Прим. пер.">столбцов</abbr> клавиш, которые вы всегда считали слишком маленькими для использования, ... действительно используемыми.
